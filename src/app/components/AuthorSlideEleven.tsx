    ...
    <div className="relative w-full h-screen flex flex-col overflow-hidden font-sans snap-start py-[4vh] lg:py-[6vh] px-4 sm:px-8 lg:px-12 2xl:px-24 bg-[#090807]">
      ...
      >
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-[clamp(2.5rem,4vw,3.5rem)] 2xl:text-[4.5rem] font-light leading-[1.1] text-[#EAEADF] tracking-tight text-balance max-w-4xl 2xl:max-w-6xl">
            Ранний вход —{' '}
