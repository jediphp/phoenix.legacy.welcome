  ...
  return (
    <div className="relative w-full h-[100vh] flex flex-col overflow-hidden font-sans snap-start bg-[#080705]">
      ...
      >
        ...
        >
          <div className="flex-1">
            ...
            <h2 className="text-[clamp(1.5rem,4vh,4rem)] font-light leading-[1.12] text-[#EAEADF] tracking-tight text-balance max-w-[60vw]">
      ...
      <div className="absolute bottom-[5vh] left-[2vw] flex items-center gap-[1vw] z-20 pointer-events-none hidden sm:flex">
        <span className="text-[clamp(10px,1.2vh,14px)] uppercase tracking-widest text-[#A39B92]">04</span>
