  ...
  return (
    <div className="relative w-full min-h-[100svh] flex flex-col overflow-hidden font-sans snap-start py-[4vh] lg:py-[6vh] px-4 sm:px-8 lg:px-12 2xl:px-24 bg-[#090807]">
      ...
      >
        ...
        >
          <span className="inline-block px-3 py-1 rounded-full text-[9px] sm:text-[10px] 2xl:text-xs tracking-[0.25em] uppercase border border-[#A39B92]/30 text-[#A39B92] bg-[#A39B92]/5 mb-[2vh] sm:mb-[3vh]">
            Editorial Selection
          </span>
